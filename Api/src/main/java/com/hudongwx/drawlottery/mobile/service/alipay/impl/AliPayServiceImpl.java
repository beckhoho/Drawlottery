...
public class AliPayServiceImpl implements IAliPayService {
    ...
    public String createSign(Long accountId, OrderFormData formData) throws Exception {
        ...
        map.put("timestamp", URLEncoder.encode(UtilDate.getDateFormatter(),"UTF-8"));
        map.put("version", "1.0");
        map.put("notify_url", URLEncoder.encode(AlipayConfig.service,"UTF-8"));
        ...
        map.put("biz_content", URLEncoder.encode(bizcontentJson.toString(), "UTF-8"));
        //对未签名原始字符串进行签名
...
//        map4.put("biz_content", URLEncoder.encode(bizcontentJson.toString(), "UTF-8"));
        ...
        Map par = AlipayCore.paraFilter(map); //除去数组中的空值和签名参数
